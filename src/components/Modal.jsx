...
export default function Modal({ title, children, onClose }) {
  return <div className="fixed inset-0 z-[100] flex items-start justify-center overflow-y-auto bg-slate-950/55 p-4 sm:items-center sm:p-6">
    <section role="dialog" aria-modal="true" aria-label={title} className="card my-auto w-full max-w-xl p-5 shadow-2xl animate-fade-up sm:p-6">
